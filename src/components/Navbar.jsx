...
const Navbar = () =>{
    ...
    return(
        <div className="w-full h-24 bg-neutral-700 z-50 mobile-l:fixed mobile-l:h-auto relative">
            <div onClick={changeNavbar} className="absolute hidden text-gray-300 right-2 rounded-full right-2 top-2 w-8 h-8 pt-1 hover:text-white hover:bg-green-500 mobile-l:block">
