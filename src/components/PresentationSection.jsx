...
const PresentationSection = () =>{
    return(
        <div className="w-full h-auto py-2 2xl:py-24">
            <div className="inline-block w-1/2 h-128 relative text-left 2xl:h-160">
                <div className="w-3/4 h-24 absolute right-32">
            ...
            <div className=" inline-block w-128 h-128 relative 2xl:w-160 2xl:h-160">
            <div className="z-1 h-96 w-96 absolute rounded-full bg-gradient-to-r from-zinc-900 to-neutral-700 2xl:w-128 2xl:h-128"></div>
                <img className="z-10 h-full w-full absolute right-16 animate-bounce-little-slow" src={meImage} />
                <div className="w-24 h-24 bg-zinc-900 rounded-full absolute top-12 animate-bounce-big-slow 2xl:w-32 2xl:h-32">
                    <img className="h-full w-full" src={reactLogo} />
                </div>
                <div className="w-20 h-20 bg-zinc-900 rounded-full absolute bottom-8 right-20 animate-bounce-big-slow 2xl:w-24 2xl:h-24">
                    <img className="h-full w-full" src={pythonLogo} />
                </div>
                <div className="z-20 w-16 h-16 p-2 bg-zinc-900 rounded-full absolute bottom-4 left-20 animate-bounce-big-slow 2xl:w-20 2xl:h-20">
